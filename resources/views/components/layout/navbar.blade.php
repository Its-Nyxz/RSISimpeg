            ...
            <div>
                <div class="hidden sm:flex items-center  lg:order-2">
                    <a href="#">
                        ...
                        <span class="text-white bg-success-950 rounded-full me-2 hover:bg-success-700  px-3  py-2"><i
                                class="fa-solid fa-user"></i></span></a>
                    <a href="{{ route('logout') }}">
                        <span class="text-white bg-success-950 rounded-full hover:bg-success-700  px-3  py-2  "><i
