<div>
    <h1 class="text-2xl font-bold text-success-900" style="margin-bottom: 20px;">Tambah Jadwal Absensi</h1>
    <form wire:submit.prevent="store">
        <div class="grid grid-cols-2 gap-4 bg-success-100 border border-success-200 rounded-lg shadow-lg p-6">
            ...
            <div class="form-group col-span-2">
                ...
                <select id="nama" wire:model="nama"
            ...
            <div class="form-group col-span-2">
                ...
                <select id="shift" wire:model="shift_id"
                    class="form-control @error('shift_id') is-invalid @enderror mt-1 block w-full rounded-lg border border-gray-300 bg-white focus:ring-success-500 focus:border-success-500 p-2.5">
            ...
            <div class="form-group col-span-2">
                ...
                <select id="opsi" wire:model="opsi_id"
                    class="form-control @error('opsi_id') is-invalid @enderror mt-1 block w-full rounded-lg border border-gray-300 bg-white focus:ring-success-500 focus:border-success-500 p-2.5">
            ...
            <div class="form-group col-span-2">
                ...
                <input type="date" id="tanggal" wire:model="tanggal"
                    class="form-control @error('tanggal') is-invalid @enderror mt-1 block w-full rounded-lg border border-gray-300 bg-white focus:ring-success-500 focus:border-success-500 p-2.5" />
                @error('tanggal')
                    <span class="text-danger text-sm">{{ $message }}</span>
                @enderror
            </div>
