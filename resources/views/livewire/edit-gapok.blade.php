    ...
    <form wire:submit.prevent="updateGapok">
        ...
        <div class="grid grid-cols-2 gap-4 bg-green-100 border border-green-200 rounded-lg shadow-lg p-6">
            <div class="form-group">
                <label for="gol_id" class="block text-sm font-medium text-green-900">Nama Golongan</label>
                <select id="gol_id" wire:model="gol_id" class="form-control @error('gol_id') is-invalid @enderror mt-1 block w-full rounded-lg border border-gray-300 bg-white focus:ring-green-500 focus:border-green-500 p-2.5">
