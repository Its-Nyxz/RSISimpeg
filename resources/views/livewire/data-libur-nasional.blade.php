        ...
        <table class="w-full text-xs sm:text-sm text-left text-gray-700">
            <thead class="text-xs sm:text-sm uppercase bg-success-400 text-success-900">
                <tr>
                    ...
                    @if (!$isStaf)
                        <th scope="col" class="px-3 py-2 sm:px-6 sm:py-3 whitespace-nowrap w-[100px] text-center">
                            Action
                        </th>
                    @endif
                </tr>
            ...
            <tbody>
                @forelse ($holidays as $holiday)
                    <tr
                        class="odd:bg-success-50 even:bg-success-100 border-b border-success-300 hover:bg-success-300 transition duration-150">
                        <td scope="row"
                            class="px-3 py-2 sm:px-6 sm:py-4 font-medium text-success-900 whitespace-nowrap">
                ...
                @empty
                    <tr>
                        <td colspan="3" class="text-center px-6 py-4 text-gray-500 italic">Tidak ada data Hari Libur.
                        </td>
                    </tr>
                @endforelse
            </tbody>
