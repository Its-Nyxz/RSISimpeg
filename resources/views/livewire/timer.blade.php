    ...
    <div class="p-4 text-left">
        ...
        <div class="mt-4 text-center" style="margin-bottom: 20px;">
            <button wire:click="startTimer"
                ...
                {{ $isRunning ? 'disabled' : '' }}>Mulai Bekerja</button>
