<div>
    <div class="flex justify-between items-center mb-5">
        <h1 class="text-2xl font-bold text-success-900">Tambah Data Tunjangan Tidak Tetap</h1>
    ...
    <form wire:submit.prevent="save">
        <div class="grid grid-cols-2 gap-4 bg-success-100 border border-success-200 rounded-lg shadow-lg p-6">
            <div class="form-group col-span-2">
                <label for="nama" class="block text-sm font-medium text-success-900">Nama Tunjangan Tidak
                    Tetap</label>
            ...
            <div class="form-group col-span-2">
                ...
                <input type="text" id="nom_makan" wire:model="nom_makan"
            ...
            <div class="form-group col-span-2">
                ...
                <input type="text" id="nom_transport" wire:model="nom_transport"
