        ...
        <div class="grid grid-cols-2 gap-4 bg-green-100 border border-green-200 rounded-lg shadow-lg p-6">
            ...
            <div class="form-group col-span-2">
                ...
                <label class="flex items-center gap-4">
                    <input type="radio" name="jenisKelamin" id="laki" wire:model.live="jenisKelamin" value="1"
                        class="form-radio h-4 w-4 text-green-600 border-gray-300 focus:ring-green-500">
                    <span class="ml-1 text-gray-900">Laki-laki</span>
                    <input type="radio" name="jenisKelamin" id="perempuan" wire:model.live="jenisKelamin" value="0"
                        class="form-radio h-4 w-4 text-green-600 border-gray-300 focus:ring-green-500">
