<div>
    <div class="flex justify-between items-center mb-5">
        <h1 class="text-2xl font-bold text-success-700">Edit Password</h1>
    ...
    <form wire:submit.prevent="updatePassword">
        <div class="bg-success-100 border border-success-200 rounded-lg shadow-lg p-6 space-y-4">
            <p class="text-success-700 font-medium mb-5">Silahkan Masukkan Password Anda yang Baru</p>

            <!-- Password Lama -->
            <div>
                <label for="current_password" class="text-sm font-medium text-success-700 block mb-1">Password
                    Lama</label>
                <input type="password" id="current_password" wire:model="current_password"
                    class="form-control w-full rounded-lg border border-gray-300 bg-white focus:ring-success-500 focus:border-success-500 p-2.5">
            ...
            <!-- Password Baru -->
            <div>
                <label for="new_password" class="text-sm font-medium text-success-700 block mb-1">Password Baru</label>
            ...
            <div>
                <label for="new_password_confirmation" class="text-sm font-medium text-success-700 block mb-1">Ulangi
                    Password Baru</label>
