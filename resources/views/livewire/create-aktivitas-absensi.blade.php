        ...
        <div class="grid grid-cols-2 gap-4 bg-green-100 border border-green-200 rounded-lg shadow-lg p-6">
            ...
            <div class="form-group col-span-2">
                ...
                <input type="text" id="user_name" wire:model.live="user_name"
                    class="form-control mt-1 block w-full rounded-lg border border-gray-300 bg-gray-100 focus:ring-green-500 focus:border-green-500 p-2.5"
                    readonly />
            </div>

            <div class="form-group col-span-2">
                <label for="tanggal" class="block text-sm font-medium text-green-900">Tanggal</label>
