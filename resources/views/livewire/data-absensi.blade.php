            ...
            <div class="flex justify-between items-center gap-4 mb-3">
                ...
                <div class="flex-1">
                    <input type="text" wire:keyup="updateSearch($event.target.value)" placeholder="Cari Shift..."
                        @if ($type === 'jadwalabsen') <div class="flex justify-between py-2 mb-3">
            ...
            <table class="w-full text-sm text-left text-gray-700">
                ...
                <tbody>
                    ...
                    @endforelse
                        ...
                        @if ($type === 'opsi') <div class="flex justify-between py-2 mb-3">
        <h1 class="text-2xl font-bold text-success-900">Opsi Absen</h1>
        <div class="flex justify-between items-center gap-4 mb-3">
            <!-- Input Pencarian -->
            <div class="flex-1">
                <input type="text" wire:keyup="updateSearch($event.target.value)" placeholder="Cari Opsi Absen..." class="w-full rounded-lg px-4 py-2 border border-gray-300 focus:outline-none focus:ring-2 focus:ring-success-600" /> @endif
                        @if ($type === 'status') <div class="flex justify-between py-2 mb-3">
                            ...
                            <tbody>
                                ...
                                @empty
                                    <tr>
                                        ...
                                        <td colspan="3" class="text-center px-6 py-4">Tidak ada data Status Absensi.
                                        </td>
