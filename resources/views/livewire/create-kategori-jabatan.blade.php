<div>
    <div class="flex justify-between items-center mb-5">
        ...
        <a href="{{ route('kategorijabatan.index') }}" class="flex items-center bg-green-700 text-white font-medium rounded-lg px-4 py-2 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300">
