<div>
    <h1 class="text-2xl font-bold text-success-900" style="margin-bottom: 20px;">Tambah Data Tunjangan Fungsional</h1>
    <form wire:submit.prevent="save">
        <div class="grid grid-cols-2 gap-4 bg-green-100 border border-green-200 rounded-lg shadow-lg p-6">
            <div class="form-group col-span-2">
                <label for="nama" class="block text-sm font-medium text-green-900">Nama Tunjangan Fungsional</label>
