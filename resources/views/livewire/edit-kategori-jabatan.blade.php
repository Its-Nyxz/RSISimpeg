<div>
    <div class="flex justify-between items-center mb-5">
        <h1 class="text-2xl font-bold text-success-900">Edit Data Kategori Jabatan</h1>
    ...
    <form wire:submit.prevent="updateKatjab">
        <div class="grid grid-cols-2 gap-4 bg-success-100 border border-success-200 rounded-lg shadow-lg p-6">
            <div class="form-group col-span-2">
                <label for="nama" class="block text-sm font-medium text-success-900">Nama Kategori</label>
            ...
            <div class="form-group col-span-2">
                <label for="tunjangan" class="block text-sm font-medium text-success-900">Jenis Tunjangan</label>
                <select id="tunjangan" wire:model="tunjangan"
                    class="form-control @error('tunjangan') is-invalid @enderror mt-1 block w-full rounded-lg border border-gray-300 bg-white focus:ring-success-500 focus:border-success-500 p-2.5">
