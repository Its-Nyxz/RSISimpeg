<div>
    <h1 class="text-2xl font-bold text-green-900 mb-6">Tambah Data Opsi Absensi</h1>
    <form wire:submit.prevent="save">
        <div class="grid grid-cols-2 gap-4 bg-green-100 border border-green-200 rounded-lg shadow-lg p-6">
            ...
            <div class="form-group col-span-2">
                ...
                <input type="text" id="name" wire:model="name" class="form-control @error('name') is-invalid @enderror mt-1 block w-full rounded-lg border border-gray-300 bg-white focus:ring-green-500 focus:border-green-500 p-2.5" />
                @error('name')
