    ...
    <form wire:submit.prevent="updateJabatan">
        <div class="grid grid-cols-2 gap-4 bg-success-100 border border-success-200 rounded-lg shadow-lg p-6">
            <div class="form-group col-span-2">
                ...
                <div class="relative">
                    <input type="text" id="katjab_id" wire:model="katjab_id_nama" placeholder="Cari Jabatan..."
                        autocomplete="off"
            ...
            <div class="form-group col-span-2">
                <label for="kualifikasi" class="block text-sm font-medium text-success-900">Kualifikasi</label>
                <input type="text" id="kualifikasi" wire:model="kualifikasi"
                    class="form-control @error('kualifikasi') is-invalid @enderror mt-1 block w-full rounded-lg border border-gray-300 bg-white focus:ring-success-500 focus:border-success-500 p-2.5" />
                @error('kualifikasi')
                    <span class="text-danger text-sm">{{ $message }}</span>
                @enderror
            </div>
