            ...
            @can('list-history-user')
                ...
                <div class="col-span-2 md:col-span-1">
                    <select wire:model.live="selectedUserId"
                        class="border border-gray-300 rounded-md px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-success-500 w-full h-full transition duration-150">
