<div>
    ...
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-bold text-success-900">Edit Data Potongan</h1>
    ...
    <form wire:submit.prevent="updatePotongan">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 bg-success-50 border border-success-200 rounded-lg shadow p-6">
            ...
            <!-- Nominal -->
            <div>
                <label for="nominal" class="block mb-1 text-sm font-semibold text-success-900">
            ...
            <div class="md:col-span-2 flex items-center space-x-2 mt-2">
                <input type="checkbox" wire:model.defer="is_wajib" id="is_wajib"
                    class="form-checkbox text-success-600">
