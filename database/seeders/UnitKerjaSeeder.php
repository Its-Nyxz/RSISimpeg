...
class UnitKerjaSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $unitsWithoutSubUnits = [
            ...
            ['name' => 'UNIT MCU & POSKES', 'kode' => 'MCU', 'keterangan' => 'MCU dan Poskes'],
            ['name' => 'UNIT TRANSPORTASI', 'kode' => 'TRANSP', 'keterangan' => 'Unit Transportasi'],
            ['name' => 'INST GIZI', 'kode' => 'GIZI', 'keterangan' => 'Instalasi Gizi'],
            ['name' => 'UNIT PJBR', 'kode' => 'PJBR', 'keterangan' => 'Penunjang Jaminan Berbasis Rumah'],
            ['name' => 'UNIT PENGELOLAAN LINEN', 'kode' => 'LINEN', 'keterangan' => 'Pengelolaan Linen'],
            ...
            ['name' => 'UNIT PEMASARAN', 'kode' => 'PEMASAR', 'keterangan' => 'Unit Pemasaran'],
