...
class MasterUmumSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $dataUmum = [
            // Rp 350.000
            ['nama' => 'Ketua SPI', 'nominal' => 350000],
            ['nama' => 'Supervisor', 'nominal' => 350000],
            ['nama' => 'Ka. Instalasi Pemeliharaan  Sarpras', 'nominal' => 350000],
            ['nama' => 'Ka. Instalasi CSSD', 'nominal' => 350000],
            ['nama' => 'Ka. Instalasi Teknologi Informasi', 'nominal' => 350000],
            ['nama' => 'Ka. Unit Ambulance', 'nominal' => 350000],
            ['nama' => 'Ka. Unit PJBR', 'nominal' => 350000],
            ['nama' => 'Ka. Unit Transportasi', 'nominal' => 350000],
            ['nama' => 'Ka. Unit Pengelolaan Linen', 'nominal' => 350000],
            ['nama' => 'Ka. Unit Gudang', 'nominal' => 350000],
            ['nama' => 'Ka. Unit Pengamanan', 'nominal' => 350000],
            ['nama' => 'Ka. Unit Pemasaran', 'nominal' => 350000],
            ['nama' => 'Staf Humas dan Program RS', 'nominal' => 350000],
            ['nama' => 'Staf SDM', 'nominal' => 350000],
            ['nama' => 'Staf Akuntansi', 'nominal' => 350000],
            ['nama' => 'Staf Keuangan', 'nominal' => 350000],
            ['nama' => 'Staf Asuransi', 'nominal' => 350000],
            ['nama' => 'Staf Aset dan Logistik', 'nominal' => 350000],
            ['nama' => 'Staf Pelayanan Medik', 'nominal' => 350000],
            ['nama' => 'Staf Keperawatan', 'nominal' => 350000],
            ['nama' => 'Staf Penunjang', 'nominal' => 350000],
            ['nama' => 'Staf Unit Pemasaran', 'nominal' => 350000],
            ...
            // Rp 250.000
            ['nama' => 'Staf Administrasi IBS', 'nominal' => 250000],
            ['nama' => 'Staf Administrasi IRJ', 'nominal' => 250000],
            ['nama' => 'Pekarya Kesehatan', 'nominal' => 250000],
            ['nama' => 'Staf Instalasi Rekam Medik', 'nominal' => 250000],
            ['nama' => 'Tenaga Non Kefarmasian', 'nominal' => 250000],
            ['nama' => 'Pelaksana IPAL', 'nominal' => 250000],
            ['nama' => 'Cleaning Service', 'nominal' => 250000],
            ['nama' => 'Staf Instalasi Gas Medik', 'nominal' => 250000],
            ['nama' => 'Staf Unit Ambulance', 'nominal' => 250000],
            ['nama' => 'Staf Instalasi Gizi', 'nominal' => 250000],
            ['nama' => 'Staf Unit Pengamanan', 'nominal' => 250000],
            ['nama' => 'Staf Unit Transportasi', 'nominal' => 250000],
            ['nama' => 'Staf Instalasi Teknologi Informasi', 'nominal' => 250000],
            ['nama' => 'Staf Unit Gudang', 'nominal' => 250000],
            ['nama' => 'Staf Unit Pengelolaan Linen', 'nominal' => 250000],
            ['nama' => 'Staf Instalasi Peml. Sarpras', 'nominal' => 250000],
            ['nama' => 'Staf Unit MCU dan Poskes', 'nominal' => 250000],
            ['nama' => 'Staf Instalasi CSSD', 'nominal' => 250000],
            ['nama' => 'Staf Unit PJBR', 'nominal' => 250000],
        ];
        ...
        foreach ($dataUmum as $item) {
            ...
            if ($katjab) {
                ...
                echo " Kategori jabatan tidak ditemukan: {$item['nama']}\n";
            }
        }
    }
}
