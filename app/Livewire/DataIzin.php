...
class DataIzin extends Component
{
    ...
    public function approveIzin($izinId, $userId)
    {
        ...
        if ($izin) {
            ...
            $message = 'Pengajuan Izin ' . $nextUser->name .
                ' mulai <span class="font-bold">' . $izin->tanggal_mulai . ' sampai ' .  $izin->tanggal_selesai .
                '</span> ' . ' dengan keterangan ' . $izin->keterangan . ' telah disetujui oleh ' . auth()->user()->name;
    ...
    public function rejectIzin($izinId, $userId)
    {
        ...
        if ($izin) {
            ...
            $message = 'Pengajuan Izin ' . $nextUser->name .
                ' mulai <span class="font-bold">' . $izin->tanggal_mulai . ' sampai ' .  $izin->tanggal_selesai .
                '</span> ' . ' dengan keterangan ' . $izin->keterangan . ' telah ditolak oleh ' . auth()->user()->name;
